...
- Dữ liệu đầu vào (Input)
	+ Tổng chi phí → số tiền điều trị cần tính toán
	+ Diện bệnh nhân → loại bệnh nhân (BHYT, VIP, THUONG)
...
| ---------------- | --------------: | ------- |
| `p_total_cost`   | `DECIMAL(18,2)` | IN      |
| `p_patient_type` |   `VARCHAR(20)` | IN      |
| `p_final_amount` | `DECIMAL(18,2)` | OUT     |
| `p_message`      |  `VARCHAR(100)` | OUT     |
- Giải pháp & các bước thực hiện
	+ Bước 1: Kiểm tra dữ liệu đầu vào
    + Bước 2: Tính tiền theo diện bệnh nhân
    + Bước 3: Trả thông báo
*/
